...
import type { VibrateEnhancedSpotifyListenersData } from '../../../services/vibrateService';
import { processTimeSeriesData, formatNumber, calculateGrowth } from './chartUtils';

interface SpotifyListenersChartProps {
  data: VibrateEnhancedSpotifyListenersData;
  loading?: boolean;
}

const SpotifyListenersChart = ({ data, loading = false }: SpotifyListenersChartProps) => {
    ...
    return (
      <div className="card p-4 h-64">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-sm font-medium text-gray-900">Spotify Listeners</h3>
                  ...
                  return (
                    <div className="bg-white p-2 rounded shadow-lg border text-xs">
                      ...
                      <div className="text-green-600">
                        Listeners: {formatNumber(payload[0].value as number)}
                      </div>
                    </div>
                  );
                }
...
export default SpotifyListenersChart;
