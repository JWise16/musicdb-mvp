...
import type { VibrateYouTubeFanbaseData } from '../../../services/vibrateService';
import { processTimeSeriesData, formatNumber, calculateGrowth } from './chartUtils';

interface YouTubeFanbaseChartProps {
  data: VibrateYouTubeFanbaseData;
  loading?: boolean;
}

const YouTubeFanbaseChart = ({ data, loading = false }: YouTubeFanbaseChartProps) => {
    ...
    return (
      <div className="card p-4 h-64">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-sm font-medium text-gray-900">YouTube Followers</h3>
                  ...
                  return (
                    <div className="bg-white p-2 rounded shadow-lg border text-xs">
                      ...
                      <div className="text-red-600">
                        Subscribers: {formatNumber(payload[0].value as number)}
                      </div>
                    </div>
                  );
                }
...
export default YouTubeFanbaseChart;
